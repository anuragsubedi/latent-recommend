...
- **Storage**: We are currently using SQLite. In Phase 2, we will likely need to migrate to PostgreSQL with `pgvector` or FAISS for efficient K-NN and cosine similarity searches across the vector density.
